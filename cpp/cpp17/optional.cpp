...
std::optional<ConstructorPrintingClass> getObject(int x) {
    ...
    // This one results in first a Default Construction followed by a move into std::optional container
    //return ConstructorPrintingClass();
    
    // This leads to only a single construction because of mandatory Copy Ellision in C++17;
