// This is purely derived from, although I found it so interestig that I to run
// it and so it makes it wouthwhile to upload to the repo as well
...
class Memory {
 public:
  void insert(Record const& r) { throw std::runtime_error("It happens"); }
};
...
class ScopeGuardImplBase {
 ...
 protected:
  ScopeGuardImplBase(const ScopeGuardImplBase& other) : commit_(other.commit_) {
    other.commit();
  }
  ~ScopeGuardImplBase() {}
