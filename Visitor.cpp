...
class List : public Element {
 public:
  void accept(Visitor const& visitor) override { visitor.visit(*this); }
};
...
class PrintVisitor : public Visitor {
 public:
  void visit(List const& l) const { std::cout << "Print List" << std::endl; }

  void visit(Bold const& b) const { std::cout << "Print Bold" << std::endl; }
};
